...
class listado_clientes extends fs_controller {
   ...
   public $total_resultados;
    ...
    public function __construct() {
        parent::__construct(__CLASS__, 'Maquinas', 'Utilidades');
    }
    ...
    public function url1()
   {
      ...
      {
         return "index.php?page=listado_clientes";
      }
      else
         return "index.php?page=listado_maquinas_cliente&cod=".$this->codcliente;
   } 
